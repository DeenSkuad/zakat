<script type="text/javascript">
    $(document).ready(function() {
        let baseUrl = "{{ route('amil-managements.index') }}";
        let createUrl = "{{ route('amil-managements.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('amil-managements.show', 'data-id') }}";
                    let editUrl = "{{ route('amil-managements.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('amil-managements.destroy', 'data-id') }}";
