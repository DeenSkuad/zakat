                    ...
                    <div class="tns" style="direction: ltr">
                        <div data-tns="true" data-tns-nav-position="bottom" data-tns-mouse-drag="true"
                            ...
                            <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                <img src="{{ asset('banners/1.png') }}" class="card-rounded shadow mw-100" alt="" />
                            </div>
                            <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                    ...
                    <div class="d-flex flex-center">
                        <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
                            <div class="d-flex flex-column flex-center h-250px w-250px h-lg-300px w-lg-300px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                                        <div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="29703818.85"
                                            data-kt-countup-prefix="RM" data-kt-countup-suffix="+">0</div>
                                    </div>
                            ...
                            <div class="d-flex flex-column flex-center h-250px w-250px h-lg-300px w-lg-300px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                                        <div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="19200059"
                                            data-kt-countup-prefix="RM" data-kt-countup-suffix="+">0</div>
                                    </div>
                                    <span class="text-gray-600 fw-semibold fs-5 lh-0">
                            ...
                            <div class="col-md-4 px-5">
                                <div class="text-center mb-10 mb-md-0">
                                    ...
                                    <div class="d-flex flex-center mb-5">
                                        ...
                                        <div class="fs-5 fs-lg-3 fw-bold text-gray-900">Kira</div>
                                    </div>
                                    <div class="fw-semibold fs-6 fs-lg-4 text-muted">Buat kiraan zakat dengan sempurna
                                        ...
                                        <br /><button type="button" class="btn btn-default">KIRA SEKARANG</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 px-5">
                                <div class="text-center mb-10 mb-md-0">
                                    ...
                                    <div class="d-flex flex-center mb-5">
                                        ...
                                        <div class="fs-5 fs-lg-3 fw-bold text-gray-900">Bayar</div>
                                    </div>
                                    <div class="fw-semibold fs-6 fs-lg-4 text-muted">Pelbagai saluran bayaran zakat
                                        tersedia
                                        <br />untuk anda menunaikan zakat
                                        <br /><button type="button" class="btn btn-default">BAYAR SEKARANG</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 px-5">
                                <div class="text-center mb-10 mb-md-0">
                                    ...
                                    <div class="d-flex flex-center mb-5">
                                        ...
                                        <div class="fs-5 fs-lg-3 fw-bold text-gray-900">Semak</div>
                                    </div>
                                    <div class="fw-semibold fs-6 fs-lg-4 text-muted">Semak bayaran zakat, tebus mata
                                        ...
                                        <br /><button type="button" class="btn btn-default">SEMAK SEKARANG</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="text-center mb-17">
                        <h3 class="fs-2hx text-gray-900 mb-5" id="clients"
                            data-kt-scroll-offset="{default: 125, lg: 150}">Maklum Balas Pelanggan</h3>
                    </div>
                            ...
                            <div class="col-lg-6 ps-lg-16">
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex fw-semibold flex-column me-20">
                                        ...
                                        <a href="#"
                                            class="text-white opacity-50 text-hover-primary fs-5 mb-6">Sistem Sewaan</a>
                                        <a href="#"
                                            class="text-white opacity-50 text-hover-primary fs-5 mb-6">Sistem Aduan</a>
                                        <a href="#"
                                            class="text-white opacity-50 text-hover-primary fs-5 mb-6">Aplikasi Mudah
                                            Alih</a>
                                    </div>
                        ...
                        <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                            <div class="d-flex align-items-center order-2 order-md-1">
                                ...
                                <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1"
                                    href="#">&copy; 2024 Zakat Fintech</span>
                            </div>
