<script type="text/javascript">
    $(document).ready(function() {
        let baseUrl = "{{ route('kariahs.index') }}";
        let createUrl = "{{ route('kariahs.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('kariahs.show', 'data-id') }}";
                    let editUrl = "{{ route('kariahs.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('kariahs.destroy', 'data-id') }}";
