                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" action="{{ route('auth.authenticate') }}" method="POST">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Zakat Fintech</div>
                                <!--end::Subtitle=-->
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="No. Kad Pengenalan" name="ic_no" autocomplete="off"
                            ...
                            <div class="fv-row mb-3">
                                <!--begin::Password-->
                                <input type="password" placeholder="Kata Laluan" name="password" autocomplete="off"
                                    class="form-control bg-transparent" />
                                <!--end::Password-->
                            </div>
                            <!--end::Input group=-->
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">Belum Daftar?
                                <a href="{{ route('auth.register') }}" class="link-primary">Daftar Baharu</a>
                            </div>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->
