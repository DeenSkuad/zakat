        ...
        <form method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('district.fields', ['action' => 'create'])
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn bg-secondary" data-bs-dismiss="modal">Tutup</button>
                    <button type="button" class="btn bg-primary" data-action="{{ route('districts.store') }}" onClick="btnCreate(this)">Simpan</button>
                </div>
            </div>
        </form>
    </div>
