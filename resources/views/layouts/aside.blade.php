        ...
        <div class="hover-scroll-overlay-y mx-3 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @if(auth()->user()->hasRole('Admin'))
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('asnaf-managements.*') ? 'active' : '' }}"
                                href="{{ route('asnaf-managements.index') }}">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-abstract-13 fs-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('claims.*') ? 'active' : '' }}"
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('amil-managements.index') ? 'active' : '' }}"
                                href="{{ route('amil-managements.index') }}">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-abstract-13 fs-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('tenants.index') ? 'active' : '' }}"
                ...
                @if(auth()->user()->hasRole('Penyewa'))
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('tenants.*') ? 'active' : '' }}"
                                href="{{ route('tenants.index') }}">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-abstract-13 fs-2">
                                        <span class="path1"></span>
