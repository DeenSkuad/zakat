<script type="text/javascript">
    $(document).ready(function() {
        let baseUrl = "{{ route('districts.index') }}";
        let createUrl = "{{ route('districts.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('districts.show', 'data-id') }}";
                    let editUrl = "{{ route('districts.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('districts.destroy', 'data-id') }}";
