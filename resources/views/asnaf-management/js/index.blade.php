<script type="text/javascript">
    $(document).ready(function() {
        let baseUrl = "{{ route('asnaf-managements.index') }}";
        let createUrl = "{{ route('asnaf-managements.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    ...
                    let editUrl = "{{ route('asnaf-managements.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('asnaf-managements.destroy', 'data-id') }}";
