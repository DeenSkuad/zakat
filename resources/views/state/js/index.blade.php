<script type="text/javascript">
    $(document).ready(function() {
        let baseUrl = "{{ route('states.index') }}";
        let createUrl = "{{ route('states.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('states.show', 'data-id') }}";
                    let editUrl = "{{ route('states.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('states.destroy', 'data-id') }}";
