<script type="text/javascript">
    $(document).ready(function() {
        let baseUrl = "{{ route('cities.index') }}";
        let createUrl = "{{ route('cities.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('cities.show', 'data-id') }}";
                    let editUrl = "{{ route('cities.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('cities.destroy', 'data-id') }}";
